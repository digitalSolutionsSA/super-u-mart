  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 16 }}>
        <p style={{ margin: 0, fontSize: 11, color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: 'Barlow, sans-serif' }}>
          SKU: {product.sku}
        </p>
        <h3 style={{ margin: '4px 0 8px', fontSize: 15, fontWeight: 700, fontFamily: 'Barlow, sans-serif', color: '#1e293b', lineHeight: 1.3 }}>
          {product.name}
        </h3>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
          ...
          {product.bulkPrice && (
            <span style={{ fontSize: 11, color: '#22c55e', fontWeight: 600, marginLeft: 'auto' }}>
              Bulk from R{product.bulkPrice.toFixed(2)}
            </span>
          )}
        </div>

        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontSize: 20, fontWeight: 800, color: '#1a2e7a', fontFamily: 'Barlow, sans-serif' }}>
